...
# --- CONFIGURATION ---
MODEL_PATH = './new_best_rknn_model'
CAMERA_WIDTH = 640
CAMERA_HEIGHT = 480
...
def robot_control_loop():
    ...
    try:
        ...
        pca = PCA9685(i2c)
        pca.frequency = 100
        left_motors = [Motor(pca, 4, 5), Motor(pca, 7, 6)]
    ...
    try:
        # Run inference
        results = model(source=1, stream=True, show=False, conf=0.1, imgsz=640, verbose=False)
        cap = None
